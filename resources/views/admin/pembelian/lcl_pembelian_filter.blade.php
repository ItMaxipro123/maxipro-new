            ...
            <div class="col-md-12">
                <div id="content" class="card p-0 p-md-4 wider" style="height: auto; min-height: 360px;">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-12">
                               <a href="javascript:void(0)" onclick="tambahRestok(this)" name="tambahButton" class="btn btn-large btn-primary btn-tambah">Add LCL</a>
                    ...
                    <table id="tabe-stok">
                        ...
                        <tr style="{{ $rowStyle }}">
                            ...
                            <td style="border: 1px solid #d7d7d7; color: black;">Rp. 
                                {{ number_format($data['subtotal_idr'], 0, ',', '.') }}
                            </td>
...
<script>
    ...
    function updateRestok(element) {
        ...
        var url = "{{ route('admin.pembelian_editview_lcl') }}";
