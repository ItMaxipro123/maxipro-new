                  ...
                  <tr>
                    ...
                    <td valign="top" style="text-align: left;">
                      ...
                      <p>
                        ...
                        {{$invoice_data['msg']['fclcontainer']['name']}}<br>

                        {{$invoice_data['msg']['fclcontainer']['address']}}

                        {{$invoice_data['msg']['fclcontainer']['city']}}
  ...
  <div class="container" style="margin-top: 20px;">
    ...
    <div class="row">
        ...
        <tr>
          ...
          <td style="text-align: left; height:auto; width:100%">
            <p style="margin: 0; line-height:0.75;">{{$invoice_data['msg']['fclcontainer']['bank_name']}}</p>
          </td>
        </tr>
        ...
        @if($matauang_kode == 'USD')
          <tr>
            ...
            <td style="text-align: left; height:auto; width:100%">
              <p style="margin: 0; line-height: 0.75;">{{$invoice_data['msg']['fclcontainer']['bank_address']}}</p>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td style="text-align: left; height:auto; width:100%">
              <p style="margin: 0; line-height: 0.75;">{{$invoice_data['msg']['fclcontainer']['swift_code']}}</p>
            </td>
          </tr>
          ...
          <td style="text-align: left; height:auto; width:100%">
              <p style="margin: 0; line-height: 0.75;">{{$invoice_data['msg']['fclcontainer']['bank_address']}}
              </p>
          </td>
          ...
          <td style="text-align: left; height:auto; width:100%">
            <p style="margin: 0; line-height: 0.75;">{{$invoice_data['msg']['fclcontainer']['swift_code']}}
            </p>
          </td>
          ...
          <td style="text-align: left; height:auto; width:100%">
          <p style="margin: 0; line-height: 0.75;">{{$invoice_data['msg']['fclcontainer']['account_no']}}
          </p>
          </td>
          ...
          <td style="text-align: left; height:auto; width:100%">
          <p style="margin: 0; line-height: 0.75;">{{$invoice_data['msg']['fclcontainer']['beneficiary_name']}}
          </p>
          </td>
          ...
          <td style="text-align: left; height:auto; width:100%">
            <p style="margin: 0; line-height: 0.75;">{{$invoice_data['msg']['fclcontainer']['beneficiary_address']}}
            </p>
          </td>
