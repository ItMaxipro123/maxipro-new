...
<h5>Download .XLSX</h5>
                    <div class="d-flex flex-wrap justify-content-between">
                        <button type="button" class="btn btn-success mx-1 my-1 flex-fill"data-id="{{ $Data['msg']['fclcontainer']['invoice_no'] }}" title="{{ $Data['msg']['fclcontainer']['invoice_no'] }}" onclick="proformaFclExcel(this)">PROFORMA INVOICE (采购订单)</button>
                        <button type="button" class="btn btn-success mx-1 my-1 flex-fill"data-id="{{ $Data['msg']['fclcontainer']['invoice_no']  }}" onclick="purchaseOrderExcel(this)">PURCHASE ORDER (采购订单)</button>
                        <button type="button" class="btn btn-success mx-1 my-1 flex-fill"data-id="{{ $Data['msg']['fclcontainer']['invoice_no']  }}" onclick="salesContractExcel(this)">SALES CONTRACT (销货合同)</button>
                        <button type="button" class="btn btn-success mx-1 my-1 flex-fill"data-id="{{ $Data['msg']['fclcontainer']['invoice_no']  }}" onclick="comercialInvoiceExcel(this)">COMMERCIAL INVOICE (商业发票)</button>
                        <button type="button" class="btn btn-success mx-1 my-1 flex-fill"data-id="{{ $Data['msg']['fclcontainer']['invoice_no']  }}" onclick="packingListExcel(this)">PACKING LIST (打包清单)</button>
                    </div>
</div>
<div class="d-flex justify-content-center align-items-center flex-column" style="width: 100%; margin-top: 20px;">
...
<script>
    ...
    function proformaFclExcel(element){
    ...
    function comercialInvoiceExcel(element){
        ...
        var invoice = $(element).data('id')
        var menu = 'commercial_invoice_excel'
