...
<body>
  ...
  @php
    ...
    $countdetail  = count($invoice_data['msg']['list_comercial_invoice']);
    ...
    @php
        ...
        <tr>
            <td style="text-align: center; vertical-align: middle;border: 1px solid #000;">
                <p style="margin: 0; padding: 0 0 2px 0; display: inline-block; line-height:   {{ isset($invoice_data['msg']['list_comercial_invoice'][$i]['name_english']) ? '1.25' : '0.5' }}; position: relative; top: -2px; font-size: 7px;">
                    {{ $i + 1 }}
                </p>
            </td>

            @if(isset($invoice_data['msg']['list_comercial_invoice'][$i]))
            <td style="text-align: center; vertical-align: middle;border: 1px solid #000;">
                <p style="margin: 0; padding: 0 0 2px 0; display: inline-block; line-height:  {{ isset($invoice_data['msg']['list_comercial_invoice'][$i]['name_english']) ? '1.25' : '0.5' }}; position: relative; top: -2px; font-size: 7px;">
                    {{ $invoice_data['msg']['list_comercial_invoice'][$i]['name_english'] }}
                </p>
            </td>
            @else
            <td style="text-align: center; vertical-align: middle;border: 1px solid #000;">
            ...
            <td style="text-align: center; vertical-align: middle;border: 1px solid #000;">
                <p style="margin: 0; padding: 0 0 2px 0; display: inline-block; line-height: {{ isset($invoice_data['msg']['list_comercial_invoice'][$i]['hs_code']) ? '1.25' : '0.5' }}; position: relative; top: -2px; font-size: 7px;">
                    {{ $invoice_data['msg']['list_comercial_invoice'][$i]['hs_code'] ?? '' }}
                </p>
            </td>

            <td style="text-align: center; vertical-align: middle;border: 1px solid #000;">
                <p style="margin: 0; padding: 0 0 2px 0; display: inline-block; line-height: {{ isset($invoice_data['msg']['list_comercial_invoice'][$i]['length_p']) ? '1.25' : '0.5' }}; position: relative; top: -2px; font-size: 7px;">
                    {{ $invoice_data['msg']['list_comercial_invoice'][$i]['length_p'] ?? '' }}
                </p>
            </td>

            <td style="text-align: center; vertical-align: middle;border: 1px solid #000;">
                <p style="margin: 0; padding: 0 0 2px 0; display: inline-block; line-height: {{ isset($invoice_data['msg']['list_comercial_invoice'][$i]['width_p']) ? '1.25' : '0.5' }}; position: relative; top: -2px; font-size: 7px;">
                    {{ $invoice_data['msg']['list_comercial_invoice'][$i]['width_p'] ?? '' }}
                </p>
            </td>

            <td style="text-align: center; vertical-align: middle;border: 1px solid #000;">
                <p style="margin: 0; padding: 0 0 2px 0; display: inline-block; line-height: {{ isset($invoice_data['msg']['list_comercial_invoice'][$i]['height_p']) ? '1.25' : '0.5' }}; position: relative; top: -2px; font-size: 7px;">
                    {{ $invoice_data['msg']['list_comercial_invoice'][$i]['height_p'] ?? '' }}
                </p>
            </td>

            <td colspan="2" style="text-align: center; vertical-align: middle; border: 1px solid #000;">
                <p style="margin: 0; padding: 0 0 2px 0; display: inline-block; line-height: {{ isset($invoice_data['msg']['list_comercial_invoice'][$i]['qty']) ? '1.25' : '0.5' }}; position: relative; top: -2px; font-size: 7px;">
                    {{ $invoice_data['msg']['list_comercial_invoice'][$i]['qty'] ?? '' }}
                    {{ isset($invoice_data['msg']['list_comercial_invoice'][$i]['qty']) ? ' Unit' : '' }}
                    @php
                        $jumlah += $invoice_data['msg']['list_comercial_invoice'][$i]['qty'] ?? 0;
                    @endphp
                </p>
            </td>
            ...
            <td style="text-align: center; vertical-align: middle;border: 1px solid #000;">
                <p style="margin: 0; padding: 0 0 2px 0; display: inline-block; line-height: {{ isset($invoice_data['msg']['list_comercial_invoice'][$i]['gross_weight']) ? '1.25' : '0.5' }}; position: relative; top: -2px; font-size: 7px;">
                    {{ $invoice_data['msg']['list_comercial_invoice'][$i]['pkgs'] ?? '' }}
                  
                </p>
            </td>
            <td style="text-align: center; vertical-align: middle;border: 1px solid #000;">
                <p style="margin: 0; padding: 0 0 2px 0; display: inline-block; line-height: {{ isset($invoice_data['msg']['list_comercial_invoice'][$i]['gross_weight']) ? '1.25' : '0.5' }}; position: relative; top: -2px; font-size: 7px;">
                    {{ $invoice_data['msg']['list_comercial_invoice'][$i]['gross_weight'] ?? '' }}
                    @php
                    $gw +=$invoice_data['msg']['list_comercial_invoice'][$i]['gross_weight'] ??0;
                    @endphp
                </p>
            </td>

            <td style="text-align: center; vertical-align: middle;border: 1px solid #000;">
                <p style="margin: 0; padding: 0 0 2px 0; display: inline-block; line-height: {{ isset($invoice_data['msg']['list_comercial_invoice'][$i]['nett_weight']) ? '1.25' : '0.5' }}; position: relative; top: -2px; font-size: 7px;">
                    {{ $invoice_data['msg']['list_comercial_invoice'][$i]['nett_weight'] ?? '' }}
                    @php
                    $nw += $invoice_data['msg']['list_comercial_invoice'][$i]['nett_weight'] ??0;
                    @endphp
                </p>
            </td>

            <td style="text-align: center; vertical-align: middle;border: 1px solid #000;">
                <p style="margin: 0; padding: 0 0 2px 0; display: inline-block; line-height: {{ isset($invoice_data['msg']['list_comercial_invoice'][$i]['cbm']) ? '1.25' : '0.5' }}; position: relative; top: -2px; font-size: 7px;">
                    {{ $invoice_data['msg']['list_comercial_invoice'][$i]['cbm'] ?? '' }}
                    @php
                    $cbm += $invoice_data['msg']['list_comercial_invoice'][$i]['cbm'] ?? 0;
                    @endphp
                </p>
            </td>
        </tr>
