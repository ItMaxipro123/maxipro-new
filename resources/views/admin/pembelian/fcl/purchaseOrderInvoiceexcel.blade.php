          ...
          <td>
            ...
            <td>
              ...
              <table>
                <tr>
                  <td>
                    <p>{{$invoice_data['msg']['fclcontainer']['name']}}</p>
                  </td>
                  <td>
                ...
                <tr>
                  <td>
                    <p>{{$invoice_data['msg']['fclcontainer']['address']}}</p>
                  </td>
                  <td>
                ...
                <tr>
                  <td>
                    <p>{{$invoice_data['msg']['fclcontainer']['city']}}</p>
                  </td>
                  <td>
                ...
                <tr>
                  <td colspan="2" style="text-align: left;">
                    <p>{{$invoice_data['msg']['fclcontainer']['phone']}}</p>
                  </td>
                </tr>
              </table>
