                               ...
                               <input type="hidden" id="lclValue" value="0">
                                ...
                                <div id="master-content" class="tab-content" style="display: none;">
                                    ...
                                    <div class="row" id="padding-top">
                                        ...
                                        <button type="button" id="backbtn" class="btn btn-large btn-warning" onclick="location.reload();">Kembali</button>
                                        </div>
                                    </div>
...
<script>
    ...
    $('#clearFilterBtn').on('click', function() {
            ...
            window.location.href = '{{ route('admin.pembelian_local') }}'; 
    })
...
<script>
    ...
    $(document).ready(function() {
                ...
                $('#tambah-pembayaran').on('click', function(e) {
                    ...
                    // AJAX request
                    $.ajax({
                        url: '{{ route('admin.pembelian_local') }}', // Replace with your server endpoint
                        type: 'GET',
                        data:{
                            form:dataToSend,
        ...
        function detailInvoice(element){
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#div_detail').show();
                    $('#judulLcl').html('<i class="fas fa-database"></i> &nbsp Detail LOCAL');
