                    ...
                    <div class="table-responsive">
                        ...
                        <table id="tabe-stok">
                            ...
                            <td style="border: 1px solid #d7d7d7; color: black; width: 10px;">
                                ...
                                <td style="border: 1px solid #d7d7d7; color: black; width:100px;">{{ $formattedDate }}</td>
                                
                                <td style="border: 1px solid #d7d7d7; color: black; width:120px;">{{ $data['invoice'] }}</td>
                                ...
                                <td style="border: 1px solid #d7d7d7; color: black;width: 200px; text-overflow: ellipsis;">{{ $data['supplier']['name'] }}</td>
                                
                                
                                <td style="border: 1px solid #d7d7d7; color: black; width:125px;">{{ $data['status_converttorupiah'] == '1' ? $data['matauang']['simbol'] : $data['matauang']['simbol'] }} 
                                ...
                                @if(count($data['ekspedisilcl']) >0)
                                    ...
                                    @foreach($data['ekspedisilcl'] as $resultekspedisi)
                                        ...
                                        <span style="color: black;">
                                           ...
                                           {{ $formattedDate = \Carbon\Carbon::parse($resultekspedisi['tgl_kirim'])->translatedFormat('d M Y')}}
                                           </p> 
                                    </span>
                                     @endforeach
                                    </td>
                                ...
                                <td style="border: 1px solid #d7d7d7; color: black; width:125px;">{{ $data['status_converttorupiah'] == '1' ? 'Rp' : $data['matauang']['simbol'] }} 
