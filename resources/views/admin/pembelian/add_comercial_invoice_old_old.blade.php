                                ...
                                <div class="modal-body">
                                            <table id="table-tambah-comercial-invoice" class="table table-striped">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $id;
                                                        $filtered_order = array_filter($order, function($item) use ($id) {
                                                            return $item['id'] === $id;
                                                        });
                    ...
                    <div class="col-sm-12" style="margin-top: 15px;">
                            ...
                            <form id="FormTambah">
                                                ...
                                                <div class="form-group" style="margin-bottom: 20px;margin-top: 10px;">
                                                        ...
                                                        <option value="">Supplier</option>
                                                            ...
                                                            @foreach($Data['msg']['supplier'] as $index => $supplier)
                                                             <option value="{{ $supplier['id'] }}" data-company="{{ $supplier['company'] }}" {{ $supplier['name'] == $supplier_option ? 'selected' : '' }}>
                                                            {{ $supplier['name'] }}
                                                            @endforeach
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                            <div style="position: relative; width: 100%;">
                                                                ...
                                                                <input type="text" class="form-control" id="company-name" name="company_name" style="border: 1px solid #ced4da; width: 100%; padding-left:20px;" value="{{ $supplier_company }}">
                                                            </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div style="position: relative; width: 100%;">
                                                            <label class="col-lg-3 control-label" style="font-size: 15px;width: 100%" for="">Alamat Perusahaan</label>
                                                            <textarea type="text" class="form-control" name="address_company" style="border: 1px solid #ced4da; width: 100%; padding-left:20px;" >{{ $supplier_alamat }}</textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div style="position: relative; width: 100%;">
                                                            <label class="col-lg-3 control-label" style="font-size: 15px;width: 100%" for="">Kota Perusahaan</label>
                                                            <input type="text" class="form-control" name="city_tambah" style="border: 1px solid #ced4da; width: 100%; padding-left:20px;" value="{{ $supplier_kota }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div style="position: relative; width: 100%;">
                                                    ...
                                                    <input type="number" class="form-control" name="telp_tambah" style="border: 1px solid #ced4da; width: 100%; padding-left:20px;width: 32%" value="{{ $supplier_notelp }}" >
                                                </div>
