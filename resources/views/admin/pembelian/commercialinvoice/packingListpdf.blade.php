...
@endphp
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <table style="width: 100%;" align="center">
          ...
          <tr>
            ...
            <td style="text-align: center;padding: 15px;">
              ...
              <h1><strong style="color: #000;font-size: 15px;">PACKING LIST<br>商业发票</strong></h1>
      ...
      <table style="width: 98%; border-collapse: collapse; margin-left:20px;" border="1">
        <tr>
        ...
        <tr>
            ...
            <td style="text-align: center; vertical-align: middle;">
                <p style="margin: 0; padding: 0 0 2px 0; display: inline-block; line-height: {{ isset($invoice_data['msg']['commercialinvoice']['detail'][$i]['nett_weight']) ? '1.25' : '0.5' }}; position: relative; top: -2px; font-size: 7px;">
                    ...
                    @php
                    $gw += $invoice_data['msg']['commercialinvoice']['detail'][$i]['nett_weight'] ??0;
                    @endphp
                </p>
            </td>
            ...
            <td style="text-align: center; vertical-align: middle;">
                <p style="margin: 0; padding: 0 0 2px 0; display: inline-block; line-height: {{ isset($invoice_data['msg']['commercialinvoice']['detail'][$i]['gross_weight']) ? '1.25' : '0.5' }}; position: relative; top: -2px; font-size: 7px;">
                    ...
                    @php
                    $nw +=$invoice_data['msg']['commercialinvoice']['detail'][$i]['gross_weight'] ??0;
                    @endphp
                </p>
            </td>
        ...
        <tr>
          ...
          <td colspan="3" style="text-align: center; vertical-align: middle;height:20px;">
