...
<body onload="window.print();">
    ...
    <div class="row">
      ...
      <table style="width: 100%;" align="center">
        ...
        <tr>
          ...
          <h1><strong style="color: #000;font-size: 15px;">{{$invoice_data['msg']['commercialinvoice']['name']}}</strong></h1>
              ...
              <table style="width: 100%">
                ...
                <tr>
                  ...
                  <td style="text-align: left;">
                      ...
                      Contract No : SC-{{$invoice_data['msg']['commercialinvoice']['contract_no']}}<br>
      ...
      <table style="width: 100%;" align="center">
          ...
          <tr>
            ...
            <td style="text-align: center;padding: 15px;">
              ...
              <h1><strong style="color: #000;font-size: 15px;">SALES CONTRACT <br> </strong></h1>
    ...
    <div class="row">
        ...
        <table style="width: 100%;border-collapse: collapse;" border="1">
            ...
            <tr>
              ...
              <td style="text-align: left;"><p style="margin: 0; margin-bottom: 12px;
              line-height: 2;">{{$invoice_data['msg']['commercialinvoice']['bank_name']}}</p></td>
            ...
            <tr>
              ...
              <td style="text-align: left;"><p style="margin: 0; margin-bottom: 12px;
              line-height: 2;">{{$invoice_data['msg']['commercialinvoice']['bank_address']}}</p></td>
            ...
            <tr>
              ...
              <td style="text-align: left;"><p style="margin: 0; margin-bottom: 12px;
              line-height: 2;">{{$invoice_data['msg']['commercialinvoice']['swift_code']}}</p></td>
            ...
            <tr>
              ...
              <td style="text-align: left;"><p style="margin: 0; margin-bottom: 12px;
              line-height: 2;">{{$invoice_data['msg']['commercialinvoice']['account_no']}}</p></td>
            ...
            <tr>
              ...
              <td style="text-align: left;"><p style="margin: 0; margin-bottom: 12px;
              line-height: 2;">{{$invoice_data['msg']['commercialinvoice']['beneficiary_name']}}</p></td>
            ...
            <tr>
              ...
              <td style="text-align: left;"><p style="margin: 0; margin-bottom: 12px;
              line-height: 2;">{{$invoice_data['msg']['commercialinvoice']['beneficiary_address']}}</p></td>
        ...
        <tr>
            <td valign="top" style="width: 60%;">
                <table style="width: 100%;">
                    <tr>
                        <td style="text-align: left;">
                            <p style="margin-bottom: 5px;">The Buyer</p>
                            <img src="https://maxipro.id/images/website/ttdmaxipro.jpg" alt="" style="width: 120px; margin-top: 0;">
                        </td>
                    </tr>
                </table>
            </td>
            ...
            <td style="width: 30%;">
                <div class="container" style="padding-top: 100px;">
                    <p >The Seller</p> <!-- Meningkatkan margin-top -->
                </div>
            </td>
        </tr>
    </table>
  ...
  <div class="container" style="margin-top: 30px;" style="text-align: left;">
