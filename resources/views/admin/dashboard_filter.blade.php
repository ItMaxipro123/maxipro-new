  ...
  <div class="container-fluid py-4">
    ...
    <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4" >        
                <div style="position: relative; width: 60%; margin-left: 90%;">
                  ...
                  <i class="fas fa-chevron-down" style="position: absolute; top: 50%; right: 15%; transform: translateY(-50%);"></i>
              </div>
  </div>
    <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                    ...
                    <tbody>
                      @php
                        array_unshift($Data['allteknisi'], [
                                ...
                                "imagedir"=> "https://maxipro.id.test.test/images/teknisi/elly-giatmoko.png"
                        ]);
                      @endphp
