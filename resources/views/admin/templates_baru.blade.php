...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0">
        ...
        <img src="https://maxipro.id.test/images/placeholder/basic.png" class="navbar-brand-img h-100 rounded-image" alt="main_logo">
        @else
      ...
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" style="display:flex;justify-content: space-between;" role="button" data-bs-auto-close="outside" data-bs-toggle="dropdown" href="#">
            ...
            <span class="nav-link-text ms-1" style="margin-right:5em;">Penjualan</span>
          </a>
          <ul class="dropdown-menu">
            <li class="nav-item">
        ...
        <li class="nav-item dropdown" >
          <a class="nav-link dropdown-toggle {{ Request::is('admin/data_restok') || Request::is('admin/data_restok_filter') || Request::is('admin/data_orderpembelian') || Request::is('admin/data_orderpembelian_filter') || Request::is('admin/data_comercialinvoice') || Request::is('admin/data_comercialinvoice_filter') ? 'active bg-gradient-primary' : '' }}" style="display: flex;justify-content: space-between;" role="button" data-bs-auto-close="outside" data-bs-toggle="dropdown" href="../pages/rtl.html">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">format_textdirection_r_to_l</i>
            </div>
            <span class="nav-link-text ms-1" style="margin-right: 5em;">Pembelian</span>
          </a>
          <ul class="dropdown-menu">
            <li class="nav-item">
