...
@section('title')
Penerimaan Pindah Gudang   | PT. Maxipro Group Indonesia
@endsection
@section('link')
                            ...
                            <div class="modal fade" id="tambahModal" tabindex="-1" role="dialog" aria-labelledby="tambahModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-xl" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="tambahModalLabel">Tambah Penerimaan Pindah Gudang</h5>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="" class="form-horizontal" id="tambahForm" method="get">
                                                @csrf
                                                <h4 style="margin-bottom: 10px;">Form Tambah Penerimaan Pindah Gudang</h4>

                                                
                                                <div class="form-group" style="display: flex; align-items: center; margin-top:30px; margin-bottom: 20px;">
                                                    <label class="col-lg-3 control-label" style="font-size: 15px;" for="id_db">Database <span style="color: red;">(Wajib Diisi)</span></label>
                                                ...
                                                <div class="form-group" id="id_pembelian_UD" style="display: none; padding-top:30px;">
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <label class="col-lg-3 control-label" style="width:100%">Barang Pindah Gudang <span style="color: red;">(Wajib Diisi)</span></label>
                                                        </div>
                                                        <div class="col-md-9">
                                                          <select class="form-control" id="id_pembelian_select1" name="id_pembelian_UD" style="border: 1px solid #ced4da; width: 100%; padding-left: 20px;" required>
                                                                    ...
                                                                    @foreach($Data['msg']['pindahgudangUD'] as $index =>$data)
                                                                        @foreach($data['detail'] as $index2 => $data2)

                                                                    <option value="new">{{ $data['code'] }} {{ $data2['barang_nama'] }} ({{ $data2['stok_input'] }})</option>
                                                                        @endforeach
                                                                    @endforeach
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div class="col-md-9">
                                                            <div style="position: relative; width: 100%;">
                                                                <select class="form-control" id="id_pembelian_select2"name="id_pembelian_PT" style="border: 1px solid #ced4da; width: 100%; padding-left: 20px;" required>
                                                                    <option value="">Pilih Barang</option>
                                                                    @foreach($Data['msg']['pindahgudangPT'] as $index =>$data)
                                                                        @foreach($data['detail'] as $index2 => $data2)
...
<script>
    ...
    window.location.href = '{{ route('admin.penerimaan_pindahgudang') }}'; // Ganti 'URL_RUTE_LAIN' dengan URL rute yang diinginkan
})
...
<script>
    ...
    $(document).ready(function() {
        ...
        if (currentUrl === '/admin/edit_pindah_gudang') {
        ...
        $(document).on('click', '.edit-btn', function(event) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        history.pushState({ code: code }, 'Edit Pindah Gudang', '{{ route('admin.edit_pindah_gudangbaru') }}' );
                    },
                    error: function(xhr, status, error) {
        ...
        $(document).on('click', '#backBtn', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    history.pushState({ page: 'penerimaan_pindahgudang' }, 'Penerimaan Pindah Gudang', '{{ route('admin.penerimaan_pindahgudang') }}');
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('saveChangesBtn').addEventListener('click', function() {
            ...
            var url = "{{ route('admin.penerimaan_pindahgudang_filter') }}" + '?' + queryString;
