                                ...
                                <div class="modal-body">
                                    <form id="dateForm">
                                        <div class="form-group">
                                            ...
                                            <input type="checkbox" id="checkdatevalue" {{ !isset($Data['msg']['checkdatevalue']) || $Data['msg']['checkdatevalue'] == 'checked' ? 'checked' : '' }}>
...
<script>
    ...
    function tambahPembelian(element) {
        ...
        const HistoryCurrent = window.location.href;
    ...
    $(document).ready(function() {
        ...
        if (currentUrl === '/admin/edit_pembelian_penerimaan') {
            window.location.href='/admin/data_pembelian_penerimaan_filter'
        }
        if (window.location.pathname === '/admin/data_pembelian_penerimaan_filter') {
