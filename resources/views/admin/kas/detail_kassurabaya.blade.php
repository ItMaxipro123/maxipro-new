...
@section('content')
@if(request()->routeIs('admin.kasdetail'))


    <h4 style="margin-bottom: 10px;">Form Detail Kas Surabaya </h4>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <div class="input-group">
                ...
                <input type="text" value="{{ $data['msg']['kaskeluar']['tgl_transaksi'] }}" class="form-control" name="tgl_transaksi" id="tgl_transaksi" style="padding-left:25px;border: 1px solid #ced4da;"readonly>
            </div>
        </div>
    </div>
    <div class="form-group" style="display: flex; align-items: center; margin-top:50px; margin-bottom: 20px;">
        ...
        <div style="position: relative; width: 100%;">
            <input type="text" class="form-control" name="name" value="{{ $data['msg']['kaskeluar']['name'] }}" style="border: 1px solid #ced4da; width: 100%; padding-left:20px;"readonly>
        </div>
    </div>
    <div class="form-group" style="display: flex; align-items: center; margin-top:50px; margin-bottom: 20px;">
        <label class="col-lg-3 control-label" style="font-size: 15px;" for="">Harga</label>
        <div style="position: relative; width: 100%;">
            <input type="number" class="form-control" name="harga" value="{{ $data['msg']['kaskeluar']['price'] }}" style="border: 1px solid #ced4da; width: 100%; padding-left:20px;"readonly>
        </div>
    </div>
    ...
    <div class="form-group" style="display: flex; align-items: center; margin-top:50px; margin-bottom: 20px;">
        ...
        <div style="position: relative; width: 100%;">
                  <select class="select select2 select-search form-control" id="ppn" name="ppn" style="border: 1px solid #ced4da; width: 100%;" readonly>
    ...
    <div class="form-group" style="display: flex; align-items: center; margin-top:50px; margin-bottom: 20px;">
        ...
        <div style="position: relative; width: 100%;">
            <input type="text" class="form-control" id="pic" name="pic" value="{{ $data['msg']['kaskeluar']['pic'] }}" style="border: 1px solid #ced4da; width: 100%; padding-left:20px;"readonly>
        </div>
    </div>
    ...
    <div class="form-group" style="display: flex; align-items: center; margin-top:50px; margin-bottom: 20px;">
        ...
        <div style="position: relative; width: 100%;">
            <select class="select select2 select-search form-control" id="money_from" name="money_from" style="border: 1px solid #ced4da; width: 100%;" readonly>
    ...
    <div class="form-group" style="display: flex; align-items: center; margin-top:50px; margin-bottom: 20px;">
        ...
        <div style="position: relative; width: 100%;">
            <input type="text" class="form-control" id="keterangan" name="keterangan" value="{{ $data['msg']['kaskeluar']['keterangan'] }}" style="border: 1px solid #ced4da; width: 100%; padding-left:20px;" readonly>
        </div>
    </div>
    <div class="form-group" style="display: flex; align-items: center; margin-top:50px; margin-bottom: 20px;">
        <label class="col-lg-3 control-label" style="font-size: 15px;" for="">Invoice</label>
        <div style="position: relative; width: 100%;">
            <input type="text" class="form-control" id="invoice" name="invoice" value="{{ $data['msg']['kaskeluar']['invoice'] }}" style="border: 1px solid #ced4da; width: 100%; padding-left:20px;" readonly>
        </div>
    </div>
    ...
    <div class="form-group" style="display: flex; align-items: center;margin-top:50px; margin-bottom: 20px;">
        ...
        <div style="position: relative; width: 100%;">
            <select class="select select2 coa-search form-control" id="name_coa" name="name_coa" style="border: 1px solid #ced4da; width: 100%;" readonly>
...
@elseif(request()->routeIs('admin.kasedit_pengeluaranpt'))
    <form action="" class="form-horizontal" method="get">
        ...
        <div class="form-group" style="display: flex; align-items: center; margin-top:50px; margin-bottom: 20px;">
            <label class="col-lg-3 control-label" style="font-size: 15px;" for="">PPN</label>
            <div style="position: relative; width: 100%;">
                <select class="select select2 select-search form-control" name="ppn" style="border: 1px solid #ced4da; width: 100%;" readonly>
                    @if($data['msg']['kaskeluar']['ppn'] == 0)
                    <option value="0" style="text-align: center;" selected>Tidak</option>
                    <option value="1" style="text-align: center;">Ya</option>
                    @else
        ...
        <div class="form-group" style="display: flex; align-items: center; margin-top:50px; margin-bottom: 20px;">
            <label class="col-lg-3 control-label" style="font-size: 15px;" for="">PIC</label>
            <div style="position: relative; width: 100%;">
                <input type="text" class="form-control" name="pic" value="{{ $data['msg']['kaskeluar']['pic'] }}" style="border: 1px solid #ced4da; width: 100%; padding-left:20px;"readonly>
            </div>
        </div>
...
<script>
    function submitForm() {
        ...
        function submitForm() {
            ...
            $.ajax({
                type: 'GET',
                url: "{{ route('admin.kassurabaya_edit') }}",
                data: formData,
                success: function(response) {
                    ...
                    Swal.fire({
                        icon: 'success',
                        title: 'Success',
                        text: 'Kas Keluar Berhasil Diedit!',
                    }).then((result) => {
