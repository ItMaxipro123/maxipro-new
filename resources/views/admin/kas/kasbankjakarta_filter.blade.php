...
<script>
    ...
    function updateVoucher(element) {
        ...
        var url = "{{ route('admin.kasedit_bankjakarta') }}";
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('saveChangesBtn').addEventListener('click', function() {
            ...
            var url = "{{ route('admin.kasbankjakarta_filter') }}" + '?' + queryString;
            ...
            fetch(url)
                ...
                .then(data => {
                    ...
                    var reloadUrl = "{{ route('admin.kasbankjakarta_filter') }}" + '?' + '&checkdatevalue=' + encodeURIComponent(checkdatevalue) + '&tgl_awal=' + encodeURIComponent(tgl_awal) + '&tgl_akhir=' + encodeURIComponent(tgl_akhir);
