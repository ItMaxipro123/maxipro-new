...
<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg wider">
    ...
    <div class="container-fluid">
        <h4 id="judulStok" style="margin-top: 40px;margin-bottom: 40px;"><i class="fas fa-database"></i> &nbsp Kas Surabaya</h4>
        <!-- <small class="display-block" style="padding-left: 35px;">Stok {{ $username['data']['teknisi']['name'] }}</small> -->
        <small class="display-block" style="position: absolute; top: 70px; left: 50px;">Kas Surabaya {{ $username['data']['teknisi']['name'] }}</small>
    </div>
            ...
            <div class="col-md-12">
                <div id="content" class="card p-0 p-md-4 wider" style="height: auto; min-height: 360px;">
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-12">
                                <a href="{{ route('admin.tambah_kas') }}" class="btn btn-large btn-primary" style="width:13%">Tambah Transaksi</a>
                        ...
                        <table id="tabe-stok" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <a href="javascript:void(0)" onclick="detailKas(this)" data-id="{{ $data['id'] }}" name="editButton" class="btn btn-large btn-info btn-detail">Detail</a>
                        ...
                        <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">          
                            <div class="modal-dialog modal-xl" role="document"> <!-- Added 'modal-lg' class for large size -->
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="editModalLabel">Edit Kas Surabaya</h5>
                                    </div>
                                    <!-- Modal body -->
                                    <div class="modal-body">
                                        <form id="editForm">
                         ...
                         <div class="modal fade" id="detailModal" tabindex="-1" role="dialog" aria-labelledby="detailModalLabel" aria-hidden="true">          
                            <div class="modal-dialog modal-xl" role="document"> <!-- Added 'modal-lg' class for large size -->
                                <div class="modal-content">
                                    <!-- Header modal, including close button -->
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="editModalLabel">Detail Kas Surabaya</h5>
                                    </div>
                                    <!-- Modal body -->
                                    <div class="modal-body">
                                        <form id="detailForm">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('saveChangesBtn').addEventListener('click', function() {
            ...
            var url = "{{ route('admin.kassurabaya_filter') }}" + '?' + queryString;
            ...
            fetch(url)
                ...
                .then(data => {
                    ...
                    var reloadUrl = "{{ route('admin.kassurabaya_filter') }}" + '?' + '&checkdatevalue=' + encodeURIComponent(checkdatevalue) + '&tgl_awal=' + encodeURIComponent(tgl_awal) + '&tgl_akhir=' + encodeURIComponent(tgl_akhir);
