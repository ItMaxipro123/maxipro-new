...
<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg wider">
    ...
    <div class="container-fluid">
        <h4 id="judulStok" style="margin-top: 40px;margin-bottom: 40px;"><i class="fas fa-database"></i> &nbsp Kas Jakarta</h4>
        <!-- <small class="display-block" style="padding-left: 35px;">Stok {{ $username['data']['teknisi']['name'] }}</small> -->
        <small class="display-block" style="position: absolute; top: 70px; left: 50px;">Kas Jakarta {{ $username['data']['teknisi']['name'] }}</small>
    </div>
                        ...
                        <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-xl" role="document"> <!-- Added 'modal-lg' class for large size -->
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="editModalLabel">Edit Kas Jakarta</h5>
                                    </div>
                                    <!-- Modal body -->
                                    <div class="modal-body">
                                        <form id="editForm">
...
<script>
    ...
    function updateVoucher(element) {
        ...
        var url = "{{ route('admin.kasedit_kasjakarta') }}";
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('saveChangesBtn').addEventListener('click', function() {
            ...
            var url = "{{ route('admin.kasjakarta_filter') }}" + '?' + queryString;
            ...
            fetch(url)
                ...
                .then(data => {
                    ...
                    var reloadUrl = "{{ route('admin.kasjakarta_filter') }}" + '?' + '&checkdatevalue=' + encodeURIComponent(checkdatevalue) + '&tgl_awal=' + encodeURIComponent(tgl_awal) + '&tgl_akhir=' + encodeURIComponent(tgl_akhir);
