                        ...
                        <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-xl" role="document"> <!-- Added 'modal-lg' class for large size -->
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="editModalLabel">Edit Kas Bank Surabaya</h5>
                                    </div>
                                    <!-- Modal body -->
                                    <div class="modal-body">
                                        <form id="editForm">
...
<script>
    ...
    function updateVoucher(element) {
        ...
        var url = "{{ route('admin.kasedit_banksurabaya') }}";
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('saveChangesBtn').addEventListener('click', function() {
            ...
            var url = "{{ route('admin.kasbanksurabaya_filter') }}" + '?' + queryString;
            ...
            fetch(url)
                ...
                .then(data => {
                    ...
                    var reloadUrl = "{{ route('admin.kasbanksurabaya_filter') }}" + '?' + '&checkdatevalue=' + encodeURIComponent(checkdatevalue) + '&tgl_awal=' + encodeURIComponent(tgl_awal) + '&tgl_akhir=' + encodeURIComponent(tgl_akhir);
